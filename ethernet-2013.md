...
- [FPGAで作ればわかる Ethernet物理層とデータリンク層 2012](#fpgaで作ればわかる-ethernet物理層とデータリンク層 2012)
 	- [はじめに](#はじめに)
...
ワークショップでは，FPGA開発環境の使い方メインで話を組み立てましたが，文章では，FPGAベンダに依存するような内容は極力扱わずに，回路設計メインで進めていきます．
...
この回路を使えば，対向リピータハブの処理遅延を8ns単位で調べたり，LANケーブルの長さを30cm単位で測ることができます．ネットワークテスタ，スイッチやルータ，Middleboxといった，通常のネットワークデバイス開発の基礎の部分になります．
